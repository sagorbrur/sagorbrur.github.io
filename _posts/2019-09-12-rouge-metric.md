...
categories:
  ...
  - nlp
classes: wide
excerpt: This blog describes about ROUGE metric.
---
...
![Rouge_Precision ](/images/rouge1.PNG)
...
* Installing PyRouge and use easily from [this](https://github.com/pltrdy/rouge) link.
